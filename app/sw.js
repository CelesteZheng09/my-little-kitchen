...
const CACHE = 'my-kitchen-v16';
const ASSETS = [
  './', './index.html', './manifest.json',
  './css/app.css?v=20260618-v6m',
  './js/db.js?v=20260618-v6m', './js/match.js?v=20260618-v6m', './js/parser.js?v=20260618-v6m', './js/app.js?v=20260618-v6m',
