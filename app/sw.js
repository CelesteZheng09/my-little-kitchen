...
const CACHE = 'my-kitchen-v17';
const ASSETS = [
  './', './index.html', './manifest.json', './config.js?v=20260618-v6n',
  './css/app.css?v=20260618-v6n',
  './js/db.js?v=20260618-v6n', './js/match.js?v=20260618-v6n', './js/parser.js?v=20260618-v6n', './js/app.js?v=20260618-v6n',
