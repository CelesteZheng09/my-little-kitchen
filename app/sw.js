...
const CACHE = 'my-kitchen-v6';
const ASSETS = [
  './', './index.html', './manifest.json',
  './css/app.css?v=20260618-v6d',
  './js/db.js?v=20260618-v6d', './js/match.js?v=20260618-v6d', './js/parser.js?v=20260618-v6d', './js/app.js?v=20260618-v6d',
