...
const CACHE = 'my-kitchen-v9';
const ASSETS = [
  './', './index.html', './manifest.json',
  './css/app.css?v=20260618-v6g',
  './js/db.js?v=20260618-v6g', './js/match.js?v=20260618-v6g', './js/parser.js?v=20260618-v6g', './js/app.js?v=20260618-v6g',
