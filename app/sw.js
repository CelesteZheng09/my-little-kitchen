...
const CACHE = 'my-kitchen-v13';
const ASSETS = [
  './', './index.html', './manifest.json',
  './css/app.css?v=20260618-v6j',
  './js/db.js?v=20260618-v6j', './js/match.js?v=20260618-v6j', './js/parser.js?v=20260618-v6j', './js/app.js?v=20260618-v6j',
